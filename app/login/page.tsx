        ...
        <div className="relative z-10 flex flex-col justify-between h-full p-14">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 mt-8">
              {["بوت واتساب تلقائي", "إدارة المواعيد", "شاشة الانتظار", "تذكيرات ذكية"].map((f) => (
                <span key={f} className="text-xs text-blue-200 bg-white/10 border border-white/15 rounded-full px-3 py-1.5 font-medium">{f}</span>
              ))}
            </div>
          </div>
