...
const FRONT_REGIONS: Region[] = [
  ...
  { id: "ribcage",         labelAr: "القفص الصدري",         shape: "ellipse", cx: 480, cy: 590, rx: 318, ry: 210 },
  // Shoulders
  { id: "left_shoulder",   labelAr: "مفصل الكتف الأيسر",   shape: "ellipse", cx: 140, cy: 428, rx: 92,  ry: 72  },
  { id: "right_shoulder",  labelAr: "مفصل الكتف الأيمن",   shape: "ellipse", cx: 820, cy: 428, rx: 92,  ry: 72  },
  // Upper arms
  ...
  // Elbows
  { id: "left_elbow",      labelAr: "مفصل الكوع الأيسر",   shape: "ellipse", cx: 142, cy: 828, rx: 64,  ry: 48  },
  { id: "right_elbow",     labelAr: "مفصل الكوع الأيمن",   shape: "ellipse", cx: 818, cy: 828, rx: 64,  ry: 48  },
  // Forearms
  ...
  // Wrists
  { id: "left_wrist",      labelAr: "مفصل الرسغ الأيسر",   shape: "ellipse", cx: 133, cy: 1142, rx: 58, ry: 38  },
  { id: "right_wrist",     labelAr: "مفصل الرسغ الأيمن",   shape: "ellipse", cx: 827, cy: 1142, rx: 58, ry: 38  },
  // Pelvis
  { id: "pelvis",          labelAr: "الحوض",                shape: "ellipse", cx: 480, cy: 1046, rx: 232, ry: 80 },
  { id: "left_hip",        labelAr: "مفصل الورك الأيسر",   shape: "ellipse", cx: 296, cy: 1094, rx: 102, ry: 96 },
  { id: "right_hip",       labelAr: "مفصل الورك الأيمن",   shape: "ellipse", cx: 664, cy: 1094, rx: 102, ry: 96 },
  // Thighs
  ...
  // Knees
  { id: "left_knee",       labelAr: "مفصل الركبة اليسرى",  shape: "ellipse", cx: 296, cy: 1514, rx: 70,  ry: 56  },
  { id: "right_knee",      labelAr: "مفصل الركبة اليمنى",  shape: "ellipse", cx: 664, cy: 1514, rx: 70,  ry: 56  },
  // Lower legs
  ...
  // Ankles
  { id: "left_ankle",      labelAr: "مفصل الكاحل الأيسر",  shape: "ellipse", cx: 294, cy: 1778, rx: 78,  ry: 48  },
  { id: "right_ankle",     labelAr: "مفصل الكاحل الأيمن",  shape: "ellipse", cx: 666, cy: 1778, rx: 78,  ry: 48  },
  // Feet
  { id: "left_foot",       labelAr: "عظام القدم اليسرى",   shape: "ellipse", cx: 266, cy: 1814, rx: 110, ry: 46  },
  { id: "right_foot",      labelAr: "عظام القدم اليمنى",   shape: "ellipse", cx: 694, cy: 1814, rx: 110, ry: 46  },
];
...
const BACK_REGIONS: Region[] = [
  ...
  { id: "sacrum",           labelAr: "العجز والعصعص",      shape: "ellipse", cx: 480, cy: 970,  rx: 76,  ry: 86  },
  // Scapulas (visible from back only)
  { id: "left_scapula",     labelAr: "لوح الكتف الأيسر",  shape: "ellipse", cx: 220, cy: 538,  rx: 138, ry: 160 },
  { id: "right_scapula",    labelAr: "لوح الكتف الأيمن",  shape: "ellipse", cx: 740, cy: 538,  rx: 138, ry: 160 },
  // Clavicles
  ...
  // Ribcage (from back)
  { id: "ribcage_b",        labelAr: "القفص الصدري",       shape: "ellipse", cx: 480, cy: 590,  rx: 318, ry: 210 },
  // Shoulders
  { id: "left_shoulder_b",  labelAr: "مفصل الكتف الأيسر", shape: "ellipse", cx: 140, cy: 428,  rx: 92,  ry: 72  },
  { id: "right_shoulder_b", labelAr: "مفصل الكتف الأيمن", shape: "ellipse", cx: 820, cy: 428,  rx: 92,  ry: 72  },
  // Arms
  ...
  { id: "left_elbow_b",     labelAr: "مفصل الكوع الأيسر", shape: "ellipse", cx: 142, cy: 828,  rx: 64,  ry: 48  },
  { id: "right_elbow_b",    labelAr: "مفصل الكوع الأيمن", shape: "ellipse", cx: 818, cy: 828,  rx: 64,  ry: 48  },
  ...
  // Pelvis & hips
  { id: "pelvis_b",         labelAr: "الحوض",              shape: "ellipse", cx: 480, cy: 1046, rx: 232, ry: 80  },
  { id: "left_buttock",     labelAr: "الأرداف الأيسر",    shape: "ellipse", cx: 340, cy: 1050, rx: 130, ry: 90  },
  { id: "right_buttock",    labelAr: "الأرداف الأيمن",    shape: "ellipse", cx: 620, cy: 1050, rx: 130, ry: 90  },
  // Thighs
  ...
  // Knees
  { id: "left_knee_b",      labelAr: "الركبة اليسرى",     shape: "ellipse", cx: 296, cy: 1514, rx: 70,  ry: 56  },
  { id: "right_knee_b",     labelAr: "الركبة اليمنى",     shape: "ellipse", cx: 664, cy: 1514, rx: 70,  ry: 56  },
  ...
  // Heels/Calcaneus
  { id: "left_heel",        labelAr: "الكعب الأيسر",      shape: "ellipse", cx: 286, cy: 1792, rx: 76,  ry: 46  },
  { id: "right_heel",       labelAr: "الكعب الأيمن",      shape: "ellipse", cx: 674, cy: 1792, rx: 76,  ry: 46  },
  // Feet
  { id: "left_foot_b",      labelAr: "عظام القدم اليسرى", shape: "ellipse", cx: 268, cy: 1820, rx: 108, ry: 44  },
  { id: "right_foot_b",     labelAr: "عظام القدم اليمنى", shape: "ellipse", cx: 692, cy: 1820, rx: 108, ry: 44  },
];
