...
const TOOTH_COORDS: { num: number; x: number; y: number; w: number; h: number }[] = [
  ...
  { num: 23, x: 530, y: 140, w: 38, h: 120 }, // ناب
  { num: 24, x: 584, y: 140, w: 44, h: 120 }, // ضاحك
  { num: 25, x: 638, y: 140, w: 44, h: 120 }, // ضاحك
  { num: 26, x: 692, y: 140, w: 50, h: 120 }, // رحى
  { num: 27, x: 746, y: 140, w: 50, h: 120 }, // رحى
  { num: 28, x: 800, y: 140, w: 50, h: 120 }, // رحى
