...
const TOOTH_COORDS: { num: number; x: number; y: number; w: number; h: number }[] = [
  ...
  { num: 14, x: 202, y: 140, w: 44, h: 120 }, // ضاحك
  { num: 13, x: 280, y: 140, w: 44, h: 120 }, // ناب
  { num: 12, x: 352, y: 140, w: 30, h: 120 }, // رباعي — مُزاح نحو 11
  { num: 11, x: 388, y: 140, w: 44, h: 120 }, // ثنية
  // ── الصف العلوي — يسار (21 → 28) ──
  { num: 21, x: 455, y: 140, w: 44, h: 120 }, // ثنية
  { num: 22, x: 527, y: 140, w: 30, h: 120 }, // رباعي — مُزاح نحو 23
  { num: 23, x: 563, y: 140, w: 44, h: 120 }, // ناب
  { num: 24, x: 617, y: 140, w: 44, h: 120 }, // ضاحك
  ...
  { num: 44, x: 202, y: 278, w: 44, h: 120 },
  { num: 43, x: 280, y: 278, w: 44, h: 120 },
  { num: 42, x: 352, y: 278, w: 30, h: 120 }, // رباعي — مُزاح نحو 41
  { num: 41, x: 388, y: 278, w: 44, h: 120 },
  // ── الصف السفلي — يسار (31 → 38) ──
  { num: 31, x: 455, y: 278, w: 44, h: 120 },
  { num: 32, x: 527, y: 278, w: 30, h: 120 }, // رباعي — مُزاح نحو 33
