...
const TOOTH_COORDS: { num: number; x: number; y: number; w: number; h: number }[] = [
  ...
  { num: 12, x: 325, y: 140, w: 30, h: 120 }, // رباعي
  { num: 11, x: 380, y: 140, w: 44, h: 120 }, // ثنية
  // ── الصف العلوي — يسار (21 → 28) ──
  { num: 21, x: 453, y: 140, w: 44, h: 120 }, // ثنية
  ...
  { num: 42, x: 325, y: 278, w: 30, h: 120 },
  { num: 41, x: 380, y: 278, w: 44, h: 120 },
  // ── الصف السفلي — يسار (31 → 38) ──
  { num: 31, x: 453, y: 278, w: 44, h: 120 },
