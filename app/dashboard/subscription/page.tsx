...
const PLANS: Array<{
...
}> = [
  {
    ...
    name: "أساسية",
    title: "لبداية منظمة",
    pitch: "للطبيب الذي يريد تنظيم الحجز والدور بدون تعقيد.",
    outcome: "بداية مرتبة بدل الدفتر والرسائل المتفرقة.",
    price: PLAN_PRICES.basic,
    tone: "from-sky-50 via-[#f8fbf8] to-[#f3faf6] ring-sky-100",
    dot: "bg-sky-600",
    bestFor: "عيادة صغيرة أو بداية تشغيل",
    features: ["حجز واتساب", "قائمة المراجعين", "شاشة انتظار", "أوقات العمل"],
  },
  {
    id: "standard",
    name: "متوسطة",
    title: "الأفضل للتشغيل اليومي",
    pitch: "للعيادة النشطة التي تحتاج سجلات طبية وتذكيرات تقلل الغياب.",
    outcome: "تشغيل يومي أسرع ومتابعة أفضل للمراجعين.",
    price: PLAN_PRICES.standard,
    tone: "from-emerald-50 via-[#f8fbf8] to-[#f2faf5] ring-emerald-100",
    dot: "bg-emerald-600",
    highlight: "الأكثر مناسبة",
    bestFor: "عيادة عليها حجوزات يومية",
    features: ["كل الأساسية", "سجلات طبية", "تذكيرات واتساب", "مراجعات قادمة"],
  },
  {
    id: "premium",
    name: "مميزة",
    title: "لعيادة أكثر احترافية",
    pitch: "للعيادة التي تريد صورة احترافية، تقارير أوضح، ودعم أسرع.",
    outcome: "تحكم أعلى بالتشغيل وتجربة أقوى أمام المراجعين.",
    price: PLAN_PRICES.premium,
    tone: "from-indigo-50 via-[#f8fbf8] to-[#f2f8fb] ring-indigo-100",
    dot: "bg-indigo-600",
    bestFor: "عيادة تريد تجربة Premium",
    features: ["كل المتوسطة", "تقارير تشغيل", "دعم أولوية", "تحسينات تجربة"],
  },
];
