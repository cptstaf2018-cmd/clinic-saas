...
export const metadata = {
  ...
  description: "بوت واتساب ذكي، تذكيرات تلقائية، سجلات طبية، وشاشة انتظار. كل ما تحتاجه لإدارة عيادتك في مكان واحد.",
};
    ...
    <main dir="rtl" className="min-h-screen bg-[#020B18] text-white overflow-x-hidden">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-slate-400 font-medium leading-relaxed mb-8">
                البوت يستقبل رسائل المرضى، يتعرف عليهم، ويحجز لهم موعداً في ثوانٍ.
              </p>
              <div className="space-y-3">
                {[
                  "يعمل 24/7 بدون توقف",
                  "يتعرف على المريض عند العودة تلقائياً",
                  "يرسل تذكيرات قبل الموعد بـ 24 ساعة",
            ...
            <div className="card-glow rounded-3xl p-6 space-y-4 float">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="whatsapp-bubble-reply px-4 py-2.5 w-fit max-w-[85%] ml-auto">
                  <p className="text-slate-200 font-medium">مرحباً أحمد 👋<br/>المواعيد المتاحة:<br/>1️⃣ 04:00 مساءً<br/>2️⃣ 04:20 مساءً<br/>3️⃣ 05:00 مساءً</p>
                </div>
                <div className="whatsapp-bubble px-4 py-2.5 w-fit mr-auto">
                  <p className="text-slate-300 font-medium">2</p>
                </div>
                <div className="whatsapp-bubble-reply px-4 py-2.5 w-fit max-w-[85%] ml-auto">
                  <p className="text-slate-200 font-medium">✅ تم تأكيد موعدك!<br/>4:20 مساءً — نراك قريباً 🏥</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="features" className="py-24 px-6 mesh-bg">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {[
              { icon: "📅", title: "إدارة المواعيد", desc: "تقويم ذكي — تأكيد وإلغاء بضغطة واحدة." },
              { icon: "📺", title: "شاشة الانتظار", desc: "شاشة عامة تعرض المريض الحالي والقادمين تلقائياً." },
              { icon: "🦷", title: "خريطة الأسنان", desc: "تأشير علاجات كل سن بالألوان — لعيادات الأسنان." },
              { icon: "📋", title: "السجل الطبي", desc: "شكاوى، تشخيص، وصفات — كل التاريخ في مكان واحد." },
              { icon: "🖨️", title: "وصفة طبية رسمية", desc: "وصفة احترافية بشعار العيادة — طباعة بضغطة واحدة." },
              { icon: "💳", title: "إدارة الاشتراكات", desc: "دفع يدوي أو عبر SuperKey — تحكم كامل للأدمن." },
            ].map((f) => (
      ...
      <section className="py-24 px-6 mesh-bg">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="text-slate-400 font-medium mb-10 text-lg">14 يوم مجاناً — بدون بطاقة ائتمان</p>
